class StudentManager {
	...
	async updateStudent(token: string, student: Alumno): Promise<Alumno> {
		try {
			...
			console.log("StudentManager: URL de la API:", this.API_URL + "api/alumnos/" + student.id);
			console.log("StudentManager: Token:", token);
			console.log("StudentManager: Estudiante:", student);

			const response = await fetch(this.API_URL + "api/alumnos/" + student.id, {
				method: "PUT",
				headers: {
					Authorization: "Bearer " + token,
					"Content-Type": "application/json",
	...
	async deleteStudent(token: string, id: number): Promise<void> {
		try {
			...
			console.log("StudentManager: URL de la API:", this.API_URL + "api/alumnos/" + id);
			console.log("StudentManager: Token:", token);

			const response = await fetch(this.API_URL + "api/alumnos/" + id, {
				method: "DELETE",
				headers: {
					Authorization: "Bearer " + token,
					"Content-Type": "application/json",
